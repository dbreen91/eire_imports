 ...
 module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat:{
      dist:{
        src:['modules/_base/javascript/build/PageVariables.js','modules/blocks/**/javascript/*','modules/_base/javascript/build/utilities/*','modules/_base/javascript/build/main.js'],
